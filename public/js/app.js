...
function crearCardHTML(tarea) {
    ...
    return ` 
        <article class="tarea-card prioridad-${tarea.prioridad} ${tarea.completada ? "completada" : ""}" data-id="${tarea.id}">
            ...
            <div class="tarea-meta">
                ...
                <div class="tarea-acciones">
                    <button class="btn-accion toggle" onclick="manejarToggle(${tarea.id})" title="${tarea.completada ? "Marcar pendiente" : "Completar"}">
                        ${tarea.completada ? "↩" : "✓"}
                    </button>
                    <button class="btn-accion eliminar" onclick="manejarEliminar(${tarea.id})" title="Eliminar">
                        ✗
                    </button>
                </div>
            </div>
